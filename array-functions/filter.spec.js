...
describe('Given function filter', () => {
    ...
    describe('When receive [1,2,3],(i) => i === 2', () => {
        test('Then should be [2]', () => {
            const values = [[1, 2, 3], (i) => i === 2];
    ...
    describe('When receive ["a","b","c"],(a,i) => i === 1', () => {
        test('Then should be ["b"]', () => {
            const values = [['a', 'b', 'c'], (a, i) => i === 1];
    ...
    describe('When receive ["a","b","c"],(a,i,arr) => i === arr.length - 1', () => {
        test('Then should be ["c"]', () => {
            const values = [
                ['a', 'b', 'c'],
                (a, i, arr) => i === arr.length - 1,
            ];
